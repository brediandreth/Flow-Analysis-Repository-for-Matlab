...
%     color2 = [237 248 177]./255;
    ...
    color1 = [58,13,121]./255;
    color12 = [0,98,246]./255;
    color2 = [0,251,228]./255;
    ...
    color1 = [67,4,99]./255;
    color12 = [0,148,252]./255;
    color2 = [158,255,219]./255;
    
    M1 = floor(M/2);
    M2 = M-M1;
    
    out1 = [linspace(color1(1), color12(1), M1)' linspace(color1(2), color12(2), M1)' linspace(color1(3), color12(3), M1)'];
    out2 = [linspace(color12(1), color2(1), M2+1)' linspace(color12(2), color2(2), M2+1)' linspace(color12(3), color2(3), M2+1)'];
